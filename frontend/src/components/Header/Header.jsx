      ...
      <div className="container mx-auto flex items-center justify-between p-4">
        ...
        <div className="flex items-center gap-8">
          <Link to="/select" className="flex items-center gap-3">
            ...
            <span className="text-xl font-bold text-gray-800">EduGuideX</span>
          </Link>
          {/* Only show navigation when user is logged in (not on home, login, or signup pages) */}
          {location.pathname !== "/home" && location.pathname !== "/login" && location.pathname !== "/signup" && location.pathname !== "/" && (
